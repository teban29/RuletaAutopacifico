"""
Django settings for autopacifico project.
...
SECRET_KEY = 'django-insecure-y2ge0@o)oii(-5)dh!du)cabx%p2993nic_vszvdug$f8*54*x'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # Asegúrate de que tu estructura de directorios coincida con esto
]
